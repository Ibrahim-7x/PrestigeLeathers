...
class PageController extends Controller
{
    ...
    {
        return [
            ['slug' => 'racing-suits', 'name' => 'Racing Suits', 'description' => 'Track-proven protection for the ultimate ride', 'icon' => 'suit', 'count' => 2],
            ['slug' => 'jackets', 'name' => 'Leather Jackets', 'description' => 'Style and safety engineered as one', 'icon' => 'jacket', 'count' => 3],
            ['slug' => 'pants', 'name' => 'Riding Pants', 'description' => 'Move freely with full protection', 'icon' => 'pants', 'count' => 2],
            ['slug' => 'gloves', 'name' => 'Gloves', 'description' => 'Precision grip with armored confidence', 'icon' => 'gloves', 'count' => 2],
            ['slug' => 'boots', 'name' => 'Boots', 'description' => 'Ground-up protection for every ride', 'icon' => 'boots', 'count' => 2],
            ['slug' => 'accessories', 'name' => 'Accessories', 'description' => 'Complete your gear setup', 'icon' => 'accessories', 'count' => 1],
        ];
    }
    ...
    {
        return [
            ['name' => 'Marcus Reed', 'role' => 'Professional Racer', 'text' => 'The Apex Pro suit saved me in a 120mph highside. The armor held up perfectly and I walked away without a scratch. Prestige Leathers is the only brand I trust on track.', 'rating' => 5],
            ['name' => 'Elena Vasquez', 'role' => 'Adventure Rider', 'text' => 'I\'ve ridden through 15 countries in my Nomad Touring Suit. Rain, sun, cold — it handles everything. The quality of the leather only gets better with age.', 'rating' => 5],
            ['name' => 'James Chen', 'role' => 'Daily Commuter', 'text' => 'The Maverick Cafe Racer Jacket turns heads everywhere I go. It\'s comfortable enough for my daily commute and tough enough for weekend canyon rides.', 'rating' => 5],
            ['name' => 'Sarah Mitchell', 'role' => 'Track Day Enthusiast', 'text' => 'Finally found a brand that makes gear for women that actually fits properly. The custom sizing options from Prestige Leathers are game-changing.', 'rating' => 5],
        ];
    }
